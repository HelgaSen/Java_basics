...
public class Selection {
    ...
    public boolean laptopIsCorrect(Laptop laptop) {
        ...
        for (Criterion criterion : criterionList) {
            ...
            if (criterion.property.equals("colour")) {
            ...
            } else if (criterion.property.equals("manufacturer")) {
                valuelaptop = laptop.getManufacturer();
            } else {
                continue;
            }
    ...
    public Selection(Set<Laptop> laptops) {
        this.scanner = new Scanner(System.in);
        this.laptops = laptops;
    }

    public Selection(Set<Laptop> laptops, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.laptops = laptops;
